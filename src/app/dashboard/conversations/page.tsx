      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        {(!conversations || (conversations as any[]).length === 0) ? (
          <div className="glass rounded-xl p-12 text-center text-[#5A6B82]">
            No conversations yet. When a customer messages your number, it will appear here.
          </div>
        ) : (
            ...
            {(conversations as any[]).map((c: any) => (
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-[#5A6B82]">{new Date(c.created_at).toLocaleString('en-US')}</div>
                </div>
